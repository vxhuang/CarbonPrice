...
ggsave("Figures/fig_basic_2.jpeg", fig_basic_1, width = 7.08, height = 6.33)
...
ggsave("Figures/fig7_Deaths_box3.jpeg", plot = fig_3, width = 10, height = 5)
...
ggsave("Figures/fig_mech_1_IAMC.jpeg", width = 7.08, height = 6.69)
...
ggsave("Figures/fig_mech_2.jpeg", tmpfig5, width = 7.08, height = 6.69)
