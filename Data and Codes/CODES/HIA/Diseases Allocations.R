...
for (d in diseases) {
  for (i in 1:5) {
    ...
    d_SSP <- read.csv(paste0("~/Documents/PSU/2020 Summer/Research/HEALED_1_CODES/International Futures (v764)/", 
    ...
    d_SSP$country <- c(d_SSP$country[c(-seq(649, 684, 2), -seq(685, 720, 2), -seq(1982, 2017, 2))], rep(NA, 54))
    d_SSP <- d_SSP %>% drop_na()
